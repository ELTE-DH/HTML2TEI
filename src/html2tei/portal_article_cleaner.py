...
def init_portal(log_dir, output_dir, run_params, portal_name, tei_logger, warc_level_params, rest_config_params):
    ...
    get_meta_fun_spec, article_root_params, decompose_spec, excluded_tags_spec, create_soup_fun, portal_url_prefix, \
    ...
    portalspec_params_and_dicts = (create_soup_fun, article_root_params, decompose_spec, excluded_tags_spec,
