...
def get_meta_from_articles_spec(tei_logger, url, bs):
    ...
    if bs.find('div', class_='mindenkozben_post_content content'):
        ...
        if pub_date is not None:
            ...
            if parsed_date is not None:
                ...
                tei_logger.log('WARNING', f'{url}  UNKNOWN DATE FORMAT')
        else:
    ...
    elif 'https://divany.hu/' in url:  # bs.find('div', class_='e-article-body'):
        ...
        if len(authors) > 0:
            ...
            # <a class="c-human_details_infos_name
